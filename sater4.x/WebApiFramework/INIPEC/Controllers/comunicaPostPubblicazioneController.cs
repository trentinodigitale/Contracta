            ...
            try
            {
                ...
                switch (datiScheda.tipoScheda.ToUpper())
                {
                    case "S2":
						...
						//La scheda S2 può essere fatta solo a fronte di un appalto con P1_16 o P7_2 o P2_16
						if (tipoSchedaGara != TipoScheda.P1_16 && tipoSchedaGara != TipoScheda.P7_2 && tipoSchedaGara != TipoScheda.P2_16)
							throw new ApplicationException("Il crea-scheda per la S2 può essere effettuato solo a fronte di una P1_16 o di una P7_2 o P2_16");
					...
					case "S1":
						...
						//La scheda S1 può essere fatta solo a fronte di un appalto con P1_16 o P7_1_2 o P2_16
						if (tipoSchedaGara != TipoScheda.P1_16 && tipoSchedaGara != TipoScheda.P7_1_2 && tipoSchedaGara != TipoScheda.P2_16 )
							throw new ApplicationException("Il crea-scheda per la S1 può essere effettuato solo a fronte di una P1_16 o di una P7_1_2 o P2_16");
                    ...
                    case "A1_29":
                        ...
                        payload = pu.getPayloadA1_29(datiScheda.idgara, datiScheda.idAppalto, datiScheda.IdDoc_Scheda);
