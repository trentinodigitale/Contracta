...
/* AGGIUNTA AF DEL FILTRO PER LIMITARE LA LUNGHEZZA DEL FILE NAME */
plupload.addFileFilter('max_file_name', function (value, file, cb)
{
    if (value && !file.name && file.name.length > value)
    {
        alert('superato il limite massimo dei file');
        this.trigger('Error', {
            code: plupload.FILE_NAME_SIZE_ERROR,
