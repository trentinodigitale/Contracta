...
function InvioDati(param) {
	...
	var po_checked = false;
	var pi_checked = false;
	var rup_checked = false;

	if (po)
		po_checked = po.checked;
	if (pi)
		pi_checked = pi.checked;
	if (rup)
		rup_checked = rup.checked;


	//if (po.checked == false && pi.checked == false && rup.checked == false &&  RecuperaValore(rup_pdg) == 0 && respPeppol == false  )
	if (po_checked == false && pi_checked == false && rup_checked == false && RecuperaValore(rup_pdg) == 0 && respPeppol == false) {
