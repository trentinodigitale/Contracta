...
function DownLoadCSV()
{
    ...
    ExecFunction('../../Report/CSV_LOTTI.asp?IDDOC=' + getObjValue('IDDOC') + '&VIEW=DOCUMENT_PROGRAMMAZIONE_DETTAGLI&HIDECOL=CODICE_CUI&TIPODOC=QUESTIONARIO_PROGRAMMAZIONE&MODEL=MODELLO_BASE_PROGRAMMAZIONE_' + TipoBando + '_Fabb_Questionario&HIDECOL=ESITORIGA'  , '_blank' ,'');
...
function DownLoadCSV_Raccolta()
{
    ...
    ExecFunction('../../Report/CSV_LOTTI.asp?IDDOC=' + getObjValue('LinkedDoc') + '&VIEW=DOCUMENT_PROGRAMMAZIONE_DETTAGLI&HIDECOL=CODICE_CUI&TIPODOC=QUESTIONARIO_PROGRAMMAZIONE&MODEL=MODELLO_BASE_PROGRAMMAZIONE_' + TipoBando + '_Fabb_Questionario&HIDECOL=ESITORIGA'  , '_blank' ,'');
...
function OnClickProdotti( obj )
{
    ...
    if ( DOCUMENT_READONLY == "1" )
        ...
        ImportExcel( 'CAPTION_ROW=yes&TITLE=Upload Excel&TABLE=CTL_Import&FIELD=RTESTATA_PRODOTTI_MODEL_Allegato&SHEET=0&PARAM=posizionale&PROCESS=LOAD_PRODOTTI,QUESTIONARIO_PROGRAMMAZIONE&OWNER_FIELD=Idpfu&OPERATION=INSERT#new#400,300' );
}
