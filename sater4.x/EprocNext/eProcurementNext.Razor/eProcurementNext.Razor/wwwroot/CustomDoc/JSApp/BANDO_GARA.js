...
function PCP_obbligatoryFields(clicked) {
    ...
    if (TipoScheda == 'P7_1_3')
        listaCampiObblig = 'CATEGORIE_MERC@DESC_LUOGO_ISTAT@Appalto_PNRR@DataTermineQuesiti_V@pcp_CodiceCentroDiCosto@pcp_Categori@pcp_ServizioPubblicoLocale@pcp_PrestazioniComprese@pcp_saNonSoggettaObblighi24Dicembre2015@pcp_CondizioniNegoziata@MOTIVAZIONE_CIG@TIPO_FINANZIAMENTO@pcp_ImportoFinanziamento@pcp_iniziativeNonSoddisfacenti@pcp_ContrattiDisposizioniParticolari@pcp_lavoroOAcquistoPrevistoInProgrammazione';

	if (TipoScheda == 'P1_19')
	{	
		listaCampiObblig ='pcp_Categoria@pcp_CodiceCentroDiCosto@MOTIVO_COLLEGAMENTO@pcp_ServizioPubblicoLocale@pcp_ImportoFinanziamento@TIPO_FINANZIAMENTO@pcp_PrevedeRipetizioniOpzioni@pcp_lavoroOAcquistoPrevistoInProgrammazione@pcp_ripetizioniEConsegneComplementari@cn16_FundingProgramCode_eu_funded@cn16_TendererRequirementTypeCode_reserved_proc@cn16_ExecutionRequirementCode_reserved_execution@cn16_CallForTendersDocumentReference_DocumentType@cn16_CallForTendersDocumentReference_ExternalRef@cn16_OrgRicorso_Name@cn16_OrgRicorso_ElectronicMail@cn16_OrgRicorso_CompanyID@cn16_OrgRicorso_CityName@cn16_OrgRicorso_Telephone@cn16_OrgRicorso_codnuts@cn16_OrgRicorso_cap';
