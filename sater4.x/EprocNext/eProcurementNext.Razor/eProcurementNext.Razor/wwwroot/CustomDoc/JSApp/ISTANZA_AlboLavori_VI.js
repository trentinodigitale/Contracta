...
function GeneraPDF ()
{
    ...
    scroll(0,0);   
    PrintPdfSign('URL=/report/prn_' + getObj('TYPEDOC').value + '.ASP?SIGN=YES&PROCESS=ISTANZA@@@VERIFICHE_PRE_PDF&VIEW_FOOTER_HEADER=ISTANZA_AlboLavori_VI_HF_Stampe');
...
function LocalPrintPdf( param )
{
    ...
    param = '/report/prn_' + getObj('TYPEDOC').value + '.ASP?&VIEW_FOOTER_HEADER=ISTANZA_AlboLavori_VI_HF_Stampe'
    if( Stato == '' ) 
    {
