...
DrawLabel('1'); 
try { 
  FUNC_OPEN('55','29','1',getObj('lIdPfu').value,getObj('lIdMsgPar').value,'PRODUCTS','DOCUMENTAZIONE','AFLGenericDocument.clsTabProducts','3','119','DIV_DOCUMENTAZIONE','Open_DOCUMENTAZIONE');
} 
catch(e){} 
FUNC_DOCUMENTAZIONE(); 
