...
function onChangePresenzaListino()
{
	...
	else
	{
		...
		{
			//getObjValue('PresenzaListino')=0;
			getObj('PresenzaListino').checked = false;
...
function afterProcess( param )
{
	...
	if (param == 'SEND_PCP:-1:CHECKOBBLIG') 
	{
		DMessageBox('../', 'Il comando di invio sara disponibile in seguito alla risposta di presa in carico dei servizi PCP', 'Attenzione', 1, 400, 300);
	}
