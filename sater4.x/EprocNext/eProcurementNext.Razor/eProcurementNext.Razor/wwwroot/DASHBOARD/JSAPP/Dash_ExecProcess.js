	...
	else
	{
		...
		if (ID_Griglia == '' )
		{
			if (typeof isFaseII !== 'undefined' && isFaseII) {
				let Url = 'ViewerCommand.asp?IDLISTA=' + idRow + '&PROCESS_PARAM=' + param;
				closeDrawer();
				//apro il drawer
		...
		{
			if (typeof isFaseII !== 'undefined' && isFaseII) {
				let Url = '../../dashboard/ViewerCommand.asp?IDLISTA=' + idRow +'&PROCESS_PARAM=' + param ;
				closeDrawer();
				//apro il drawer
				openDrawer(`<div class="iframeRightAreaContain">
						<iframe
...
function Dash_ExecProcessDoc( param , ID_Griglia)
{
	...
	else
	{
		...
		if (ID_Griglia == '' )
		{
			...
			if (typeof isFaseII !== 'undefined' && isFaseII) {
				let Url = 'ViewerCommand.asp?IDLISTA=' + idRow + '&PROCESS_PARAM=' + param + '&DOCLISTA=' + ListDoc;
				closeDrawer();
				//apro il drawer
				openDrawer(`<div class="iframeRightAreaContain">
						<iframe
