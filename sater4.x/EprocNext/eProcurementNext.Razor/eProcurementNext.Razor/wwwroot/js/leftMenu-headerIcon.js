...
const applyWidthAndEllipsis = (elem, width, padding, index) => {
    ...
    if (elem.nodeName.toLowerCase() === "img" ||
        ...
        elem.classList.contains("DateFaseII") || elem.classList.contains("Fld_Domain_label2") || elem.classList.contains("FldExtDom_button") || elem.classList.contains("FldDomainValue") || elem.classList.contains("img_label_alt") || elem.querySelector("input[type=button].FldExtDom_button"))
 {
        return;
    }
