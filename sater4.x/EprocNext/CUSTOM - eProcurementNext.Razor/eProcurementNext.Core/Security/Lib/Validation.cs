...
namespace eProcurementNext.Security
{
    public class Validation : IValidation
    {
        ...
        public bool isValidFilterSql(string strFilter, string strConnectionString = "")
        {
            return eProcurementNext.DashBoard.Basic.isValidaSqlFilter(strFilter, strConnectionString);
        }
