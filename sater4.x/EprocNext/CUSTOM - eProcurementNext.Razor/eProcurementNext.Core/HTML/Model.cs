...
namespace eProcurementNext.HTML
{
    public class Model
    {
        ...
        private string defaultBootstrapCols = "col-12 col-md-6 col-lg-6 col-xl-4";
                ...
                if (bShow)
                {
                    ...
                    do
                    {
                        ...
                        if (numC == 1)
                        {
                            if (IsMasterPageNew())
                            {
								objResp.Write(@"<tr class=""row no-gutters"">");
                            }
                            else
                            {
                                objResp.Write("<tr>");
                        ...
                        if (fld.Value.Position == numR * NumberColumn + numC)
                        {
                            ...
                            { //'-- HR
                                ...
                                if (IsMasterPageNew())
                                {
                                    objResp.Write($@"<td class=""{defaultBootstrapCols}"" colspan=""120""><hr/></td></tr> ");
                                }
                                else
                                {
                    ...
                    do
                    {
                        ...
                        if (fld.Value.Position == numR * NumberColumn + numC)
                        {
                            ...
                            else
                            {
                                ...
                                objResp.Write($@" colspan=""{((fld.Value.colspan > 0 ? fld.Value.colspan : 1))}"" ");
                                objResp.Write($@"><table border=""0"" width=""100%"" cellpadding=""0"" cellspacing=""0""><tr>");
                                ...
                                if (IsMasterPageNew())
                                {
									objResp.Write($@"</tr><tr class=""row no-gutters"">");
                                }
                                else
                                {
								    objResp.Write($@"</tr><tr>");
