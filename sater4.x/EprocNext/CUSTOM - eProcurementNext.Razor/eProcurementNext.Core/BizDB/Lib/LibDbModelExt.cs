            ...
            try
            {
                ...
                if (bNew == true)
                {
                    ...
                    if (!string.IsNullOrEmpty(idDoc))
                    {
                        ...
                        sb.Append("where MOD_Name = @ModelName and MOD_ID = MA_MOD_ID order by ma_order");
                        strSQL = sb.ToString();
                    ...
                    if (rs is null)
                    {
                        ...
                        try
                        {
                            ...
                            sb.Append(" where MOD_Name = @ModelName and isnull( dzt.DZT_Type, ctattr.DZT_Type) is not null");
