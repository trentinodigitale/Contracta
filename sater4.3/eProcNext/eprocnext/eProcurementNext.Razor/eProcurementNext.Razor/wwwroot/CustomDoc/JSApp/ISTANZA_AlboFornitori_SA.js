...
function controlli (param)
{
	...
	{	
		...
		//punto p
		/*if ( getObj( 'check_possesso_ISO_9000_OK' ).checked == false &&  getObj( 'check_possesso_ISO_9000_NO' ).checked == false )
		{
			err = 1;
			TxtErr( 'check_possesso_ISO_9000_OK' );
			TxtErr( 'check_possesso_ISO_9000_NO' );
		}
		else
		{
			TxtOK( 'check_possesso_ISO_9000_OK' );
			TxtOK( 'check_possesso_ISO_9000_NO' );			
		} */
