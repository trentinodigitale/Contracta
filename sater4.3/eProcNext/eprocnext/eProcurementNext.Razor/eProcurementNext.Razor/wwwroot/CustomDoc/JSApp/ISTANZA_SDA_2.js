...
function controlli (param)
{
	...
	{	
		...
		//controllo la prensenza di allegati nella griglia delle classi se ci sono
		var numeroRigheCLASSI = GetProperty( getObj('GRIGLIA_CATEGORIEGrid') , 'numrow');
		if(  Number( numeroRigheCLASSI ) > 0 )
		{

			for( i = 0 ; i <= numeroRigheCLASSI ; i++ )
			{
				try
				{
					
					if( getObjValue( 'R' + i + '_AllegatoRichiesto' ) == '' )
					{
						err = 1;
						TxtErr( 'R' + i + '_AllegatoRichiesto' );
					}
					else
					{
						
						TxtOK( 'R' + i + '_AllegatoRichiesto' );
					}
		...
		if ( getObj( 'check_art_80_fallimento_1' ).checked == false &&  getObj( 'check_art_80_fallimento_2' ).checked == false &&  getObj( 'check_art_80_fallimento_3' ).checked == false &&  getObj( 'check_art_80_fallimento_4' ).checked == false &&  getObj( 'check_art_80_fallimento_5' ).checked == false &&  getObj( 'check_art_80_fallimento_6' ).checked == false )
		{
			err = 1;
		...
		if ( getObj( 'check_art_80_conflitti_1' ).checked == false &&  getObj( 'check_art_80_conflitti_2' ).checked == false )
		{
			err = 1;
			TxtErr( 'check_art_80_conflitti_1' );
			TxtErr( 'check_art_80_conflitti_2' );
						
		}
		else
		{
			TxtOK( 'check_art_80_conflitti_1' );
			TxtOK( 'check_art_80_conflitti_2' );
						
		}  
		
		if ( getObj( 'check_art_80_controllo_1' ).checked == false &&  getObj( 'check_art_80_controllo_2' ).checked == false )
		{
			err = 1;
			TxtErr( 'check_art_80_controllo_1' );
			TxtErr( 'check_art_80_controllo_2' );
						
		}
		else
		{
			TxtOK( 'check_art_80_controllo_1' );
			TxtOK( 'check_art_80_controllo_2' );
		...
		if ( getObj( 'check_art_80_appalto_1' ).checked == false &&  getObj( 'check_art_80_appalto_2' ).checked == false )
		{
			err = 1;
			TxtErr( 'check_art_80_appalto_1' );
			TxtErr( 'check_art_80_appalto_2' );
						
		}
		else
		{
			TxtOK( 'check_art_80_appalto_1' );
			TxtOK( 'check_art_80_appalto_2' );
...
function OnChangeCheck(obj)
{
	...
	if ( name.substring(0,name.length - 2) == 'check_art_80' && valore == '1' )
	{
	...
	if ( name.substring(0,name.length - 2) == 'check_art_80_fallimento' && valore == '1' )
	{
