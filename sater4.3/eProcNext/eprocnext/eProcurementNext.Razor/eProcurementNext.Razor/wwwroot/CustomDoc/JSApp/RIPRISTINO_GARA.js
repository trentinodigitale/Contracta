...
{
	//nascondo i campi relativi a termine richiesta quesiti se non è una proroga del BANDO_GARA
	
	if( getObjValue('JumpCheck') != 'BANDO_GARA' &&  getObjValue('Caption') != 'RichiestaQuesiti:1' )	
	{		
