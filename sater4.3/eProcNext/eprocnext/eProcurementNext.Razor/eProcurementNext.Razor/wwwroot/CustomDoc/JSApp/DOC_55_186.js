...
function NewSend( param ){
  ...
  //se PARAM è vuoto è il SEND e allora faccio i controlli
  if ( param == '' ) {
...
//rimappo la funzione che controlla se una sezione è da firmare per
...
function InitOfferta() {
  ...
  try{                                                                            
    ...
    //se valoreoffertalavori è 0 e lo stato non è inviato rilancio il calcolo totale della griglia economica
    //perchè ho invertito l'ordine della griglia e dell'area comune che 
...
function ResetFirmaCauzione(){
   ...
   if ( strValueSignCauzione == '0#1' ){
      ...
      //se la busta Microlotti è da firmare ed è stata resettata la firma per un cambiamento
