...
function ViewerUpd( grid , indRiga , indCol )
{
	var cod;
	var CurFilter;
	var CurPage;
	...
	var URL = 'ViewerAddNew.ASP?' +  'MODE=UPD&IDROW=' + escape(cod) + '&' + CurQueryString;
	
	//ExecFunction( 'ViewerAddNew.ASP?' +  'MODE=UPD&IDROW=' + escape(cod)+ '&Filter=' + CurFilter + '&nPag=' + CurPage + '&Sort=' + CurSort + '&SortOrder=' + CurSortOrder + '&Table=' + CurTable + CurQueryString, 'ViewerAddNew' , '' );
	ExecFunction( URL, 'ViewerAddNew' , '' );
