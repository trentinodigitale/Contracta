...
namespace eProcurementNext.BizDB
{
    public class LibDbAttach
    {
        ...
        public string AllegaFirma(ISession session, HttpContext httpContext, string accessGuid, string filePath, string fileOriginalName, string TABLE = "", string IDDOC = "", string CIF = "0", string IDENTITY = "", string AREA = "")
        {
            return LibDbAttach.UpLoadAttachSign(session, httpContext, accessGuid, filePath, fileOriginalName, TABLE, IDDOC, CIF, IDENTITY, AREA);
        }
        ...
        public static string UpLoadAttachSign(ISession session, HttpContext httpContext, string accessGuid, string filePath, string fileOriginalName, string table = "", string iddoc = "", string cif = "0", string identity = "", string area = "")
        {
            if (string.IsNullOrEmpty(accessGuid) || string.IsNullOrEmpty(filePath) || string.IsNullOrEmpty(fileOriginalName))
            {
                throw new Exception("Errore UpLoadAttach, non sono stati forniti i parametri necessari");
