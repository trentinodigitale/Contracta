...
namespace eProcurementNext.Razor  //EprocNext.Session
{
    public /*internal*/ class SessionCleaningService : IHostedService //, IDisposable
    {
        ...
        {
            //TODO: Federico, viene chiamato veramente ogni 60 secondi ? ( valore configurato ) in debug mi sembrava di no
            _timer = new Timer(
                DeleteOldSessions,
                state: null,
