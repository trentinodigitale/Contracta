...
{
    public class CervedClient : IParixClient
    {
        ...
        public string getParixInfo(string CodFisc, string SessionKey, string ConnString, string extra = "")
        {
            ...
            try
            {
                ...
                Tools.InsertParixDati(sqlConn, "LOG_CERVED", CodFisc, "JSON_CERVED_ENTITY_SEARCH", responseString);
                ...
                Tools.InsertParixDati(sqlConn, "LOG_CERVED", CodFisc, "JSON_CERVED_ENTITY_PROFILE", responseString);
