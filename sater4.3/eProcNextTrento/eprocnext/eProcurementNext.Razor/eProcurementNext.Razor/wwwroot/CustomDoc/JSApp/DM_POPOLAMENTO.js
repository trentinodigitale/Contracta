...
function NextStep()
{
	...
	var Result = SUB_AJAX( '../../CustomDoc/DM_LOAD.asp?IDDOC=' + IdDoc_Off + '&TYPEDOC=' + TYPEDOC + '&ID_DOC_POPOLAMENTO=' + getObjValue( 'IDDOC' ) + '&STEP=' + NextRow + '&NumDM=' + NumDM + '&TotRow=' + TotRow );
	...
	//SetTextValue( 'CampoTesto_1' , Result + ' - ' + TotRow + ' - ' + NumDM + ' - ' + NextRow );
...
function ShowAvanzamentoElaborazione()
{
	...
	//SetNumericValue( 'CampoNumerico' , StatoElaborazione.NumDM );
	SetTextValue( 'CampoNumerico' , parseInt(StatoElaborazione.NumDM) );
	...
	//SetNumericValue( 'CampoNumerico_2' , StatoElaborazione.NumDM );
	//SetNumericValue( 'CampoNumerico_3' , StatoElaborazione.NumDM );
	SetTextValue( 'CampoTesto_3' , parseInt(NumDM) );
	SetTextValue( 'CampoTesto_4' , parseInt(NumDM) );
