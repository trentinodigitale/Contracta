...
function InitComunicazione() {
	...
	try {
		...
		if (getObj('JumpCheck').value.indexOf('1-') == -1 && getObj('JumpCheck').value.indexOf('COMUNICAZIONE_FORNITORE_CONVENZIONE') == -1) {
			...
			//se documento editabile e se non è COMUNICAZIONE_FORNITORE_CONVENZIONE
			if (getObj('DOCUMENT_READONLY').value != '1' && getObj('JumpCheck').value.indexOf('COMUNICAZIONE_FORNITORE_CONVENZIONE') == -1) {
