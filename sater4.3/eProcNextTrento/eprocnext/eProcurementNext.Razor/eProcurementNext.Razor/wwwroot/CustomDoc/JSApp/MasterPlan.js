...
function download_xslx()
{
	...
	objForm.action= '../CTL_Library/accessBarrier.asp?goto=xlsx.aspx&TitoloFile=MasterPlan&LEGEND=DASHBOARD_SP_MASTER_PLANfiltro&HIDECOL=identity&IDDOC=-1&TIPODOC=&MODEL=&STORED_SQL=yes&Table=DASHBOARD_SP_MASTER_PLAN' ;
