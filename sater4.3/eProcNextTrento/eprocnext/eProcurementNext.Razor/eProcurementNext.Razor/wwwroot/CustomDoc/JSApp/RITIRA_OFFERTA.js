...
function GeneraPDF ()
{
  ...
  if( trim(getObjValue( 'Body' )) == '' )
	{
	  ...
	  TxtErr( 'Body' );  	  
	  DMessageBox( '../' , 'Inserire le motivazioni per il ritiro dell\'offerta' , 'Attenzione' , 1 , 400 , 300 );
	  return -1;
  ...
  scroll(0,0);  	
  PrintPdfSign('TABLE_SIGN=CTL_DOC&lo=print&PROCESS=&PDF_NAME=Ritira Offerta&URL=/report/prn_Ritira_Offerta.asp?SIGN=YES');
