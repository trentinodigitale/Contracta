...
function Pdf_Quesiti() {
  ...
  */
  ...
  ExecFunction(pathRoot + 'CTL_Library/accessBarrier.asp?goto=pdf/pdf.asp&URL=' + encodeURIComponent(strURL) + '&PAGEORIENTATION=&VIEW_FOOTER_HEADER=GARA_QUESITI_HF_Stampe&IDDOC=' + GUID_DOC + '&TYPEDOC=');
